import { IS_MANUAL_CASE_REGEX, SMALL_WORDS_REGEX, WHITESPACE_REGEX } from '../regexes';
 ...
 */
export const shouldCapitalize = (token: string, index: number, input: string): boolean => {
